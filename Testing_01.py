...
if __name__ == "__main__":
    # load dataset
    data_train = pd.read_csv(r"C:\Users\jmelw\Desktop\FALL 22-23\FOUNDATIONS OF DS\Testing\venv\data\Iris_train.csv")
    # plot dataset
    ...
    clf.fit(X,Y)
    #setting test data
    data_test = pd.read_csv(r"C:\Users\jmelw\Desktop\FALL 22-23\FOUNDATIONS OF DS\Testing\venv\data\Iris_test.csv")
